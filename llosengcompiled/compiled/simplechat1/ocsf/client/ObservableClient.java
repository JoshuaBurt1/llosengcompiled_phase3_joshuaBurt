...
public class ObservableClient extends Observable
{
  ...
  private AdaptableClient service;
    ...
    /**
     * The client's loginId name.
     */
    private String loginId;

  //Constructor *****************************************************

  public ObservableClient(String loginId, String host, int port)
  {
      this.loginId = loginId;
      service = new AdaptableClient(loginId, host, port, this);
  }
...
// ACCESSING METHODS ------------------------------------------------
  ...
  final public void setLoginId(String loginId) {
      this.loginId = loginId;
  }
